...
-- AppUser
INSERT INTO public.app_user(name, sex, login, password, role, is_deleted) VALUES
    ('Alex', 2, 'alex@gmail.com', '$2a$12$TubK7CsuGdoLC7k/5t9rVuk895OFB1.ptaoRqT8ochIE/NDPqlwra', 1, false),
...
-- Specie
INSERT INTO public.specie(name, is_deleted) VALUES
   ('Mammal', false),
   ('Bird', false),
   ('Rodent', false),
   ('Reptile', false);
...
-- Pet
INSERT INTO public.pet(name, sex, birthday, specie_id, is_deleted) VALUES
    ('Wizard', 0, '2021-01-05', 1, false),
...
-- Users pets
INSERT INTO public.users_pets(user_id, pet_id) VALUES
    (1, 2),
    (1, 7),
    (2, 1),
    (2, 8),
...
INSERT INTO public.meal(actual_feeding_time, expected_feeding_time, food, food_amount, pet_id, is_deleted) VALUES
    ('2021-11-23T07:00:00', '2021-11-23T07:30:00', 'Dry food', 300, 1, false),
...
-- Note
INSERT INTO public.note(content, created, modified, title, user_id, pet_id, is_deleted) VALUES
    ('Wizard smiled to me =)', '2021-11-23T11:38:00', null, 'New', 2, null, false),
...
-- Vaccine
INSERT INTO public.vaccine(date_time, name, is_deleted) VALUES
    ('2021-01-20T13:30:00', 'Vaccine1', false),
    ('2021-07-20T09:00:00', 'Vaccine2', false),
    ('2021-06-15T10:00:00', 'Vaccine for cat', false),
    ('2021-04-25T15:45:00', 'Vaccine for dog', false);

-- Pet_vaccines
INSERT INTO public.pet_vaccines(pet_id, vaccines_id) VALUES
    (1, 1),
    (1, 2),
    (8, 3),
    (3, 4);
